package com.sanwenyu.stemplate.ui.poetry.adapter;
 ...
 * on 2016.09.11:27
 */
public class PoetryTypeAdapter extends CommonRecycleViewAdapter<NewsChannelTable>implements
    ...
    public PoetryTypeAdapter(Context context, int layoutId) {
